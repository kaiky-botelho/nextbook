...
ItemModel turneHeart = ItemModel(
  ...
  condition: 'Novo',
  description:
      'Riley Wynn virou uma superestrela da noite para o dia graças ao seu álbum com músicas de término e um single inesquecível. Quando seu ex-marido declara que a música de maior sucesso é sobre ele, Riley entra em contato com Max Harcourt, seu namorado da faculdade e a verdadeira inspiração para a canção do momento. Max não falava com ela desde que o relacionamento acabou, há dez anos. Ele está satisfeito administrando a casa de repouso da família, apesar de não ter a vida repleta de música com que sonhava antigamente. Riley quer revelar ao público que Max é o verdadeiro muso. Ele aceita, mas com uma condição: fazer parte da banda na turnê da cantora. Enquanto se apresentam por todo o país, os dois começam a perceber que, embora tenham tocado algumas notas erradas no passado, o futuro pode lhes reservar coisas incríveis. Eles só não sabem se o relacionamento reavivado vai sobreviver ao fim da turnê.',
  category: 'Romance',
);
...
ItemModel jovensVingadores = ItemModel(
  ...
  condition: 'Usado',
  description:
      '''Um novo grupo misterioso de jovens heróis aparece na sequência de Vingadores: A Queda. Mas quem são eles? De onde vieram? E que direito eles têm de se chamarem de Jovens Vingadores? Em Assuntos de Família, os recém-formados Jovens Vingadores se preparam para fazer sua estreia pública - mas primeiro eles têm que enfrentar uma ameaça mais poderosa que Kang, o Conquistador, mais perigoso que Mr. Hyde e mais astuto que os Mestres do Terror: seus pais!''',
  category: 'Quadrinhos',
);
...
ItemModel homemFerroSuperior = ItemModel(
  ...
  condition: 'Novo',
  description:
      '''Quanto você pagaria pela perfeição? Beleza? Imortalidade? Tony Stark sabe, e ele está pronto para dar a você - mas a um preço terrível! O efeito AXIS mudou Tony: ele está mais estiloso, confiante e astuto do que nunca. E está pronto para conduzir São Francisco ao futuro - mas o primeiro passo é lançar o Extremis por toda a cidade! Até onde Tony irá para manter o segredo de seu sucesso em segredo? À medida que as ações de Tony se tornam mais questionáveis, quem conspirará para derrubá-lo?''',
  category: 'Quadrinhos',
);
